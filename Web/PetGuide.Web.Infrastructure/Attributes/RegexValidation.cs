namespace PetGuide.Web.Infrastructure.Attributes
{
    public static class RegexValidation
    {
        ...
        public static class Event
        {
            ...
            public const string PurposeErrorMessage = "Event purpose shouldn't contain multiple whitespaces. Allowed character are 0-9.,";
            public const string Description = @"^(([A-Za-z0-9!?@#<>=.,-]\s?)+)$";
            ...
            public const string ActivitiesErrorMessage = "Event activities shouldn't contain multiple whitespaces. Allowed character are 0-9.,-";
        }
    }
}
